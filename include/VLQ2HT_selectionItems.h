...
static vector<shared_ptr<SelectionItem>> SEL_ITEMS_VLQ2HT {
    ...
    shared_ptr<SelectionItem>(new SelDatF("leading_jet_pt",    "leading ak4 jet p_{T} / 20 GeV",        50, 0., 1000                )),
    shared_ptr<SelectionItem>(new SelDatF("subleading_jet_pt", "sub-leading ak4 jet p_{T} / 20 GeV",    50, 0., 1000                )),
    shared_ptr<SelectionItem>(new SelDatF("largest_jet_eta",   "most forward ak4 jet #eta",             50, -5., 5.                 )),
    shared_ptr<SelectionItem>(new SelDatF("primary_lepton_pt", "primary lepton p_{T} / 20 GeV",     50, 0., 1000                )),
    ...
    shared_ptr<SelectionItem>(new SelDatD("ST",                "ST / 50 GeV",                       50, 0, 2500                 )),
    shared_ptr<SelectionItem>(new SelDatD("STgt70",            "STgt70 / 50 GeV",                   50, 0, 2500                 )),
