...
VLQToHiggsAndLeptonModule::VLQToHiggsAndLeptonModule(Context & ctx){
    ...
    cout << "Hello World from VLQToHiggsAndLeptonModule!" << endl;
    ...
    h_njet.reset(new VLQToHiggsAndLeptonHists(ctx, "Njet"));
    h_bsel.reset(new VLQToHiggsAndLeptonHists(ctx, "Bsel"));
